        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Creación de nuevo Role</h1>
                ...
                <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false" autocomplete="off">
                    ...
                    <div class="col-12 text-center mt-2 pt-50">
                       <button type="button" wire:click.prevent="store()" class="btn btn-primary close-modal me-1" data-bs-dismiss="modal">Guardar</button>
